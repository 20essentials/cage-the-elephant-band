...
const nameBand = 'CAGE THE ELEPHANT ';

let nameSongs = [
	" COME A LITTLE CLOSER", /*1*/
	"TROUBLE", /*2*/
	"CIGARETTE DAYDREAMS", /*3*/
	"AIN'T NO REST FOR THE WICKED", /*4*/
	"COLD COLD COLD", /*5*/
	"SOCIAL CUES", /*6*/
	"BLACK MADONNA", /*7*/
	"SKIN AND BONES", /*8*/
	...
	"TOKYO SMOKE", /*12*/
	"THE WAR IS OVER", /*13*/
	"WHAT I'M BECOMING", /*14*/
	"LOVE'S THE ONLY WAY", /*15*/
	"TAKE IT OR LEAVE IT", /*16*/
	"SHAKE ME DOWN", /*17*/
	"TOO LATE TO SAY GOODBYE", /*18*/
	"ABERDEEN", /*19*/
	"AROUND MY HEAD", /*20*/
]
